...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
    {
        variants: {
            variant: {
                primary:
                    "bg-zinc-50 text-zinc-900 hover:bg-zinc-50/90 focus-visible:ring-zinc-300",
                secondary:
                    "bg-zinc-800 text-zinc-50 hover:bg-zinc-800/80 focus-visible:ring-zinc-700",
                outline:
                    "border border-zinc-800 bg-zinc-950 hover:bg-zinc-800 hover:text-zinc-50 focus-visible:ring-zinc-800",
                ghost:
                    "hover:bg-zinc-800 hover:text-zinc-50 focus-visible:ring-zinc-800",
                danger:
                    "bg-red-900 text-zinc-50 hover:bg-red-900/90 focus-visible:ring-red-900",
            },
            size: {
                sm: "h-9 px-3 text-xs",
                md: "h-10 px-4 py-2",
