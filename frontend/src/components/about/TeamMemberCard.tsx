...
export function TeamMemberCard({
  ...
  // Entrance is orchestrated by the grid's stagger container in TeamSection
  // (one viewport trigger, ordered cascade) — no per-card inView/delay, which
  // made later cards sit invisible then pop after they were already on screen.
  return (
    <m.article variants={fadeUp} className="flex flex-col">
      <m.div
