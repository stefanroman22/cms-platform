...
/**
 * Contact page. Hero copy lives under the `contactPage` namespace; the contact
 * details (data) live in `src/content/contact.json`. The hero is static HTML
 * (instant paint, CSS fade); the info list and the message form are client
 * islands.
 */
