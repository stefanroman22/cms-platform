...
import { User, Calendar, FolderOpen, Lock, CheckCircle, Pencil, X, Mail, Sun, Moon, Palette } from "lucide-react";
          ...
          <div className="max-w-2xl">
                    ...
                    <div className="flex items-start gap-4 px-6 py-4">
                        ...
                        <div className="flex-1 min-w-0">
                            {editingName ? (
                                ...
                                <div className="flex items-center gap-2">
                                    <span className={`text-sm ${displayName ? "text-zinc-900 dark:text-zinc-100" : "text-zinc-400 dark:text-zinc-500 italic"}`}>
                                        {displayName ?? "Not set"}
                                    </span>
                                    {nameSuccess && (
            ...
            <section className={`mb-8 ${dashboardSectionCardCn}`}>
                ...
                <div className="flex items-center gap-4 px-6 py-4">
                    ...
                    >
                        ...
                        <span className={`flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${theme === "dark" ? "bg-zinc-700 text-white shadow-sm" : "text-zinc-500 hover:text-zinc-700"}`}>
            ...
            <section className={dashboardSectionCardCn}>
                ...
                <form onSubmit={handleChangePassword} className="p-6 space-y-4">
                    ...
                    />
                    <FormField label="Current password" type="password" value={currentPw} onChange={setCurrentPw} placeholder="••••••••" />
                    <FormField label="New password" type="password" value={newPw} onChange={setNewPw} placeholder="Min. 8 characters" />
                    <FormField label="Confirm new password" type="password" value={confirmPw} onChange={setConfirmPw} placeholder="••••••••" />
                    <div className="pt-1">
                        <button
                            type="submit"
