...
export default function ProjectsOverviewPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      <PageHeader
        title="Projects"
        description="All active projects associated with your account."
      />
      ...
      {loading && (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="h-36 rounded-xl border border-zinc-200 bg-white animate-pulse dark:border-zinc-800 dark:bg-zinc-900"
            />
          ))}
        </div>
      )}
